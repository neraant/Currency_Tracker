...
describe('Navigation', () => {
  ...
  test('renders timeline page on "/timeline" route', () => {
  ...
  test('renders bank card page on "/bank-card" route', () => {
  ...
  test('renders contacts page on "/contacts" route', () => {
  ...
  test('navigates to Timeline when clicking the link', async () => {
    renderWithRouter(['/']);
